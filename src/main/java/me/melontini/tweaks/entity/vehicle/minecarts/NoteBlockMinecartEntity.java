...
public class NoteBlockMinecartEntity extends AbstractMinecartEntity {
    ...
    public NoteBlockMinecartEntity(World world, double x, double y, double z) {
        super(EntityTypeRegistry.NOTEBLOCK_MINECART_ENTITY, world, x, y, z);
    }
    ...
    public void playNote(World world, Vec3d pos) {
        ...
        this.world.playSound(null, new BlockPos(pos), (Instrument.fromBelowState(world.getBlockState(new BlockPos(pos)))).getSound(), SoundCategory.RECORDS, 3.0F, f);
