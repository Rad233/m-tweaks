...
public class NoteBlockMinecartItem extends MinecartItem {
    private static final DispenserBehavior DISPENSER_BEHAVIOR = new ItemDispenserBehavior() {
        ...
        public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
            ...
            NoteBlockMinecartEntity noteBlockMinecart = (NoteBlockMinecartEntity) NoteBlockMinecartEntity.create(world, d, e + g, f, MinecartTypes.M_TWEAKS_NOTEBLOCK);
    ...
    public NoteBlockMinecartItem(Settings settings) {
        super(MinecartTypes.M_TWEAKS_NOTEBLOCK, settings);
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (!blockState.isIn(BlockTags.RAILS)) {
            ...
            if (!world.isClient) {
                ...
                NoteBlockMinecartEntity noteBlockMinecart = (NoteBlockMinecartEntity) NoteBlockMinecartEntity.create(world, (double) blockPos.getX() + 0.5, (double) blockPos.getY() + 0.0625 + d, (double) blockPos.getZ() + 0.5, MinecartTypes.M_TWEAKS_NOTEBLOCK);
